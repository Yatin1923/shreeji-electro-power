...
export const allProducts: Product[] = [...cablesData, ...fansData, ...lightingsData, ...switchgearsData, ...wiresData,...solarData, ...switchesData, ...lkData, ...neptuneData, ...dowellData,...cabsealData];
